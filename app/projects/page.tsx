...
export default async function ProjectsPage() {
  ...
  return (
    <AppShell
      auth={auth}
      title="Projekt"
      subtitle="Batch 8D: projektmallar, intake, kalkylregler och uppdrag som kan skickas till planeringsmotorn."
